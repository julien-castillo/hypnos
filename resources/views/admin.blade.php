    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mt-4">
            <div class="d-flex justify-content-end mb-2">
                {{ $hotels->links() }}
                <div>
                    <a href="{{ route('admin.hotel.create') }}" class="btn btn-primary">Ajouter un établissement</a>
                </div>
            </div>
...
{{--                        <th scope="row">{{ $loop->index +1 }}</th>--}}
                        ...
                        <td>
                            ...
                            <form id="form-{{ $hotel->id }}" action="{{ route('admin.hotel.delete', ['hotel'=>$hotel->id]) }}" method="post">
                                @csrf
